...
export class componentName extends Component {
  ...
  render() {
    const { nicotineBase, pg, vg, flavors, totals, name } =
      this.props.recipe || {};
          ...
          <Fragment>
            ...
            >
              <Table.Header>
                <Table.Row>
                  <Table.HeaderCell>
                    {width && width > 480 ? "Ingredient" : "Ing"}
                  </Table.HeaderCell>
                  <Table.HeaderCell>ml</Table.HeaderCell>
                  <Table.HeaderCell>
                    {width && width > 480 ? "Drops" : "drops"}
                  </Table.HeaderCell>
                  <Table.HeaderCell>
                    {width && width > 480 ? "Grams" : "g"}
                  </Table.HeaderCell>
                  <Table.HeaderCell>
                    {width && width > 480 ? "Percent" : "%"}
                  </Table.HeaderCell>
                </Table.Row>
              </Table.Header>
              <Table.Body>
